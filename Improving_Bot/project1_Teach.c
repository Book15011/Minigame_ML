...
// main function
int main() {
    //Input the file that want to train HERE
    const char* filename = "Q_table_red_test2.csv";
    loadQTableRedFromFile(filename);

    //printCheckQtable();
    srand(time(NULL));  // Seed random number generator

    // Training phase
    int episodes = 200000;  // Adjust as needed for training duration
